...
| ![alt]({{ site.url }}{{ site.baseurl }}/assets/images/proj4_300x180.png) | 3D object detection from LIDAR point cloud [Link]({{ site.url }}{{ site.baseurl }}/blog/post-3d-object-detect/)<br>• Top view implementation from [PIXOR](http://openaccess.thecvf.com/content_cvpr_2018/papers/Yang_PIXOR_Real-Time_3D_CVPR_2018_paper.pdf), CVPR 2018<br>• Front view implementation (in progress) |
| ![alt]({{ site.url }}{{ site.baseurl }}/assets/images/proj3_300x180.png) | A simple monocular visual odometry with motion-only bundle adjustment [[Link](https://www.youtube.com/watch?v=A5HnnSiZ_LM)] |
